...
export const setupStorageBuckets = async () => {
  try {
    ...
    for (const bucket of buckets) {
      ...
      // Note: Setting policies requires admin API access through service_role key
      // We'll need to use an alternative approach or handle policies through the Supabase dashboard
    }
